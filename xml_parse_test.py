...
def find_general_table_attribs(filespath, file, nr_of_observations):   # To find regex patterns for all elements that will be used to fill the general species table on the homepage.
    ...
    gen_data.append(nr_of_observations)
...
def master_extractor():
    ...
    #         print("+"*80)
    #         abs_path = (filespath + file) 
    #         attrib_list = xml_parse(abs_path)
    ...
    #         find_general_table_attribs(filespath, general_file, nr_of_observations)
